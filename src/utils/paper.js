...
export function generatePaper(w, h, styleName = 'vintage') {
  const style = PAPER_STYLES[styleName] || PAPER_STYLES.vintage;
  ...
  baseGrad.addColorStop(0, rgb(style.base, v1));
  baseGrad.addColorStop(0.5, rgb(style.base, 1));
  baseGrad.addColorStop(1, rgb(style.base, v2));
